...
namespace GeneratedCode
{
    public class GeneratedClass
    {
        ...
        private void GenerateWorkbookPart1Content(WorkbookPart workbookPart1)
        {
            ...
            FileVersion fileVersion1 = new FileVersion() { ApplicationName = "xl", LastEdited = "7", LowestEdited = "7", BuildVersion = "25225" };
            ...
            X15ac.AbsolutePath absolutePath1 = new X15ac.AbsolutePath() { Url = "C:\\Temp\\" };
            ...
            WorkbookView workbookView1 = new WorkbookView() { XWindow = -120, YWindow = -120, WindowWidth = (UInt32Value)51840U, WindowHeight = (UInt32Value)21240U };
            workbookView1.SetAttribute(new OpenXmlAttribute("xr2", "uid", "http://schemas.microsoft.com/office/spreadsheetml/2015/revision2", "{DDA2ED09-065B-4359-B8F3-6A328D738800}"));

            bookViews1.Append(workbookView1);

            Sheets sheets1 = new Sheets();
            Sheet sheet1 = new Sheet() { Name = "Ark1", SheetId = (UInt32Value)1U, Id = "rId1" };
        ...
        private void GenerateWorkbookStylesPart1Content(WorkbookStylesPart workbookStylesPart1)
        {
            ...
            NumberingFormat numberingFormat2 = new NumberingFormat() { NumberFormatId = (UInt32Value)165U, FormatCode = "0.000" };
            NumberingFormat numberingFormat3 = new NumberingFormat() { NumberFormatId = (UInt32Value)166U, FormatCode = "0.0000" };
            NumberingFormat numberingFormat4 = new NumberingFormat() { NumberFormatId = (UInt32Value)167U, FormatCode = "0.00000" };
            ...
            CellFormat cellFormat3 = new CellFormat() { NumberFormatId = (UInt32Value)1U, FontId = (UInt32Value)0U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)0U, FormatId = (UInt32Value)0U, ApplyNumberFormat = true };
            ...
            CellFormat cellFormat5 = new CellFormat() { NumberFormatId = (UInt32Value)2U, FontId = (UInt32Value)0U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)0U, FormatId = (UInt32Value)0U, ApplyNumberFormat = true };
            CellFormat cellFormat6 = new CellFormat() { NumberFormatId = (UInt32Value)165U, FontId = (UInt32Value)0U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)0U, FormatId = (UInt32Value)0U, ApplyNumberFormat = true };
            CellFormat cellFormat7 = new CellFormat() { NumberFormatId = (UInt32Value)166U, FontId = (UInt32Value)0U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)0U, FormatId = (UInt32Value)0U, ApplyNumberFormat = true };
            CellFormat cellFormat8 = new CellFormat() { NumberFormatId = (UInt32Value)167U, FontId = (UInt32Value)0U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)0U, FormatId = (UInt32Value)0U, ApplyNumberFormat = true };
        ...
        {
            A.Theme theme1 = new A.Theme() { Name = "Office-tema" };
        ...
        private void GenerateWorksheetPart1Content(WorksheetPart worksheetPart1)
        {
            ...
            worksheet1.SetAttribute(new OpenXmlAttribute("xr", "uid", "http://schemas.microsoft.com/office/spreadsheetml/2014/revision", "{CE6BE26C-9093-4137-8F43-0C56C247B3D9}"));
            SheetDimension sheetDimension1 = new SheetDimension() { Reference = "A1:G1" };

            SheetViews sheetViews1 = new SheetViews();

            SheetView sheetView1 = new SheetView() { TabSelected = true, WorkbookViewId = (UInt32Value)0U };
            Selection selection1 = new Selection() { ActiveCell = "G1", SequenceOfReferences = new ListValue<StringValue>() { InnerText = "G1" } };
            ...
            Cell cell4 = new Cell() { CellReference = "D1", StyleIndex = (UInt32Value)3U };
            ...
            Cell cell7 = new Cell() { CellReference = "G1", StyleIndex = (UInt32Value)6U };
        ...
        {
            document.PackageProperties.Creator = "Kjeld Poulsen";
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2022-07-08T10:00:47Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2022-07-08T10:03:09Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.LastModifiedBy = "Kjeld Poulsen";
        }
